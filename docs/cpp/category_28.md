...
```
### HCFI_FindImageByFile - 基础示例
```cpp
// C++示例代码
// 这里可以放置与说明内容相关的代码示例
代码内容;
```
### HCFI_FindImageByFile - 进阶用法
```cpp
// 示例2：HCFI_FindImageByFile 调用
// [示例2] C++示例代码
// [示例2] 这里可以放置与说明内容相关的代码示例
代码内容;
```
### HCFI_FindImageByFile - 高级应用
```cpp
// 示例3：HCFI_FindImageByFile 高级用法
// [高级] C++示例代码
// [高级] 这里可以放置与说明内容相关的代码示例
代码内容;
```
...
```
### HCFI_FindImageByMem - 基础示例
```cpp
// C++示例代码
// 这里可以放置与说明内容相关的代码示例
代码内容;
```
### HCFI_FindImageByMem - 进阶用法
```cpp
// 示例2：HCFI_FindImageByMem 调用
// [示例2] C++示例代码
// [示例2] 这里可以放置与说明内容相关的代码示例
代码内容;
```
### HCFI_FindImageByMem - 高级应用
```cpp
// 示例3：HCFI_FindImageByMem 高级用法
// [高级] C++示例代码
// [高级] 这里可以放置与说明内容相关的代码示例
代码内容;
```
